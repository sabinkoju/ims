...
@section('title')  View All Student Category  - Institute Management System (IMS) @endsection
                                                            ...
                                                            <td>
                                                                <a href="{{ route('editStudentCategory',$std_cat->id )}}"
                                                                   class="btn btn-primary btn-xs">
                                                                    ...
                                                                    <a href="javascript:" rel="{{ $std_cat->id }}" rel1="studentmanagement/delete-studentcategory" class="btn btn-danger btn-xs deleteRecord">
