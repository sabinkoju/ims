...
@section('title')  View All Categories  - Institute Management System (IMS) @endsection
                                                    ...
                                                    @foreach($categories as $key=>$category)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button href="javascript:" rel="{{$category->id}}" rel1="enquiries/delete-category" class="btn btn-danger btn-xs deleteRecord" >
