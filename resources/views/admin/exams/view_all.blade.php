...
@section('title')  View All Exams  - Institute Management System (IMS) @endsection
                                                    ...
                                                    @foreach($exams as $exam)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button href="javascript:" rel="{{ $exam->id }}" rel1="exams/delete-exam" class="btn btn-danger btn-xs deleteRecord" >
