...
@section('title') View Fee Details - Institute Management System (IMS) @endsection
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button href="javascript:" rel="{{$payment->id}}"
                                                                rel1="delete-payment"
                                                                class="btn btn-danger btn-xs deleteRecord">
                                                                <i class="fa fa-trash-o "></i>
                                                            </button>
                                                            <a href="{{route('viewpaymentreport',$payment->id)}}"
                                                                class="btn btn-primary btn-xs">
                                                                <i class="fa fa-usd"></i>
                                                            </a>
                                                        </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img src="{{ asset('uploads/course/course.png') }}"
                                                            width="150px">
                                                        @else
                                                    ...
                                                    <td>
                                                        @if($course->status == 1)
                                                        <span
                                                            class="label label-rouded label-menu label-success">Active</span>
                                                        @else
                                                        <span class="label label-rouded label-menu label-danger">In
                                                            Active</span>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button href="javascript:" rel="{{ $course->id }}"
                                                            rel1="delete-course"
                                                            class="btn btn-danger btn-xs deleteRecord">
                                                            <i class="fa fa-trash-o "></i>
                                                        </button>
