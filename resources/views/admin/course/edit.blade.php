    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Edit  Course -  {{ $course->name }}</div>
                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="duration"
                                                   ...
                                                   data-validation-error-msg="Duration is required" value="{{ $course->duration }}">
                                        </div>
                                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-body">
                        @if(!empty($course->image))
                            <img src="{{ asset('uploads/course/'.$course->image) }}" alt="{{ $course->name }}" height="200px" width="auto">
                        @else
                            <img src="{{ asset('uploads/course/course.png') }}" alt="{{ $course->name }}" height="200px" width="auto">
                        @endif
                    </div>
                </div>
            </div>
