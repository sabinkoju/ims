...
@section('title')  View All Expense Category  - Institute Management System (IMS) @endsection
                                                            ...
                                                            <td>
                                                                <a href="{{ route('editExpenseCategory', $expense_category->id) }}"
                                                                   class="btn btn-primary btn-xs">
                                                                    ...
                                                                    <button href="javascript:" rel="{{ $expense_category->id }}" rel1="account/expensemanagement/delete-expense-category" class="btn btn-danger btn-xs deleteRecord" >
